...
uploaded_file = st.file_uploader(
    "अपना 1-minute XAUUSD CSV upload करो",
    type=["csv"]
)
...
if uploaded_file is not None:
    try:
        ...
        st.success("✅ XAUUSD CSV successfully loaded!")
...
if uploaded_file is not None:
    if st.button("▶️ Run Backtest"):
        st.info(
            "डेटा successfully loaded. "
            "Actual trade-detection engine अगला module है."
        )
else:
    st.warning("CSV upload करने के बाद backtest button available होगा.")
